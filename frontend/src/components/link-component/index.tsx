...
const LinkComponent = (props: Props) => {
  ...
  return (
    <motion.button
      ...
      className="w-full max-w-[12rem] mx-1 text-left shadow group/link mb-2 rotate transition-shadow opacity-90 hover:opacity-100 h-auto overflow-hidden rounded-lg bg-zinc-50 hover:shadow-xl dark:bg-zinc-900 dark:shadow-black dark:border dark:border-zinc-800 dark:border-opacity-60"
    >
