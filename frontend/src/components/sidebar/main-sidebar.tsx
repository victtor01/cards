...
export function Sidebar() {
  ...
  return (
    <div className="flex group/sidebar relative">
      <section
        className={`flex flex-col h-screen bg-gray-100 bg-opacity-50 dark:bg-neutral-900/20 border-r dark:border-zinc-900 dark:bg-opacity-80 overflow-visible relative`}
        style={{ width: size.x }}
      >
