...
export default function Layout({ children }: PropsLayout) {
  return (
    <main className="w-full h-auto flex-1 flex flex-col">
      <header className="p-1 bg-zinc-50 border-b dark:border-zinc-800 dark:bg-zinc-900 dark:bg-opacity-70 z-30">
        <div className="flex justify-between mx-auto max-w-main items-center dark:text-zinc-300">
          ...
          <div className="flex text-zinc-500 dark:text-zinc-200">
            <button
              className={`${fontFiraCode} border bg-white text-zinc-800 rounded-md hover:ring-2 hover:ring-violet-400 dark:hover:ring-indigo-600 transition-all p-1 px-3 dark:border-zinc-700 opacity-90 hover:opacity-100 capitalize`}
            >
              Create account
            </button>
          </div>
