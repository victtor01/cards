...
// src/core/application/services/workspaces-service.spec.ts
var workspaces_service_spec_exports = {};
__export(workspaces_service_spec_exports, {
  workspacesRepositoryMock: () => workspacesRepositoryMock
});
module.exports = __toCommonJS(workspaces_service_spec_exports);
...
describe("worksapcesServices", () => {
  ...
  it("should create workspace", async () => {
    ...
    globalExpect(response).toBeInstanceOf(Workspace);
  });
  describe("#publish", () => {
    it("should throw error when worksapce not found!", async () => {
      ...
      await globalExpect(workspaceService.publish(id, userId)).rejects.toThrowError(
