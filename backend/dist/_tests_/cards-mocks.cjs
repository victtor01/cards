...
// src/_tests_/cards-mocks.ts
var cards_mocks_exports = {};
__export(cards_mocks_exports, {
  cardsRepositoryMock: () => cardsRepositoryMock
});
module.exports = __toCommonJS(cards_mocks_exports);
