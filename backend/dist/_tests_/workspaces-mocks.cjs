...
// src/_tests_/workspaces-mocks.ts
var workspaces_mocks_exports = {};
__export(workspaces_mocks_exports, {
  workspaceServiceMock: () => workspaceServiceMock
});
module.exports = __toCommonJS(workspaces_mocks_exports);
