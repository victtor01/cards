...
__decorateClass([
  (0, import_typeorm2.Column)({ type: "date" })
], Task.prototype, "startAt", 2);
__decorateClass([
  (0, import_typeorm2.Column)({ type: "date", nullable: true })
], Task.prototype, "endAt", 2);
__decorateClass([
  (0, import_typeorm2.Column)({ type: "simple-array", nullable: true })
], Task.prototype, "completed", 2);
__decorateClass([
  (0, import_typeorm2.Column)({ type: "simple-array", nullable: true })
], Task.prototype, "deleted", 2);
__decorateClass([
  (0, import_typeorm2.Column)({ type: "simple-array" })
], Task.prototype, "days", 2);
__decorateClass([
  (0, import_typeorm2.Column)({ type: "time", nullable: true })
...
Task = __decorateClass([
  (0, import_typeorm2.Entity)({ name: "tasks" })
], Task);
...
__decorateClass([
  (0, import_typeorm5.Column)({ type: "varchar", length: 100 })
...
__decorateClass([
  (0, import_typeorm5.Column)({ type: "varchar", nullable: true })
], User.prototype, "photo", 2);
__decorateClass([
  (0, import_typeorm5.OneToMany)(() => Workspace, (workspaces) => workspaces.user)
], User.prototype, "workspaces", 2);
__decorateClass([
  (0, import_typeorm5.OneToMany)(() => Task, (task) => task.user)
], User.prototype, "tasks", 2);
User = __decorateClass([
  (0, import_typeorm5.Entity)({ name: "users" })
], User);
...
async function unlinkUploadFile(filename) {
  try {
    const filePath = (0, import_path2.join)(__dirname, "..", "uploads", filename);
...
var folder = import_path3.default.resolve(__dirname, "..", "..", "..", "uploads");
var config = {
  dest: folder,
...
var Bootstrap = class {
  static async start() {
    try {
      ...
      app.use("/uploads", import_express8.default.static(import_path4.default.join(__dirname, "..", "uploads")));
      ...
      app.listen(this.port, () => {
        logger_default.info("Servidor iniciado com sucesso!");
      });
    } catch (err) {
      logger_default.error({ err }, "Erro ao tentar conectar ao banco de dados!");
    }
  }
};
Bootstrap.port = 9e3;
